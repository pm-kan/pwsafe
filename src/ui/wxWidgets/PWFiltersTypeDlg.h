...
public:
  static pwFiltersTypeDlg* Create(FieldType ftype, PWSMatch::MatchRule *rule, CItemData::EntryType *etype);
protected:
  /// Constructors
  pwFiltersTypeDlg(FieldType ftype, PWSMatch::MatchRule *rule, CItemData::EntryType *etype);
