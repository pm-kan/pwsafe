...
public:
  static pwFiltersStringDlg* Create(FieldType ftype, PWSMatch::MatchRule *rule, wxString *value, bool *fcase);
protected:
  /// Constructors
  pwFiltersStringDlg(FieldType ftype, PWSMatch::MatchRule *rule, wxString *value, bool *fcase);
